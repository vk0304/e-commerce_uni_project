...
<div class="input-group w-90 mb-2">
  ...
  <input required type="text" class="form-control" name= "cat_title" placeholder="insert categories" aria-label="categories" aria-describedby="basic-addon1">
</div>
